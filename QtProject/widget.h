...
private slots:
    ...
    void chartview_mouseClicked(int key,QPointF clickPos);
    void chartview_mouseDoubleClicked(int key,QPointF clickPos);
    void chartview_mouseMove(int key,QPointF nowPos);
    void chartview_mouseWheel(int value);
    void chartview_mouseRelease(int key,QPointF releasekPos);
