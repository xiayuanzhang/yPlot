...
{
    connect(m_scrollBar, &QScrollBar::valueChanged, this, &MyScorllBar::slot_valueChanged);
}

void MyScorllBar::setValueRange(int min, int max)
{
    m_valueMin = min;
    m_valueMax = max;
    int w = 0;
...
void MyScorllBar::slot_valueChanged(int value)
{
